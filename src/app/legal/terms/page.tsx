...
export const metadata: Metadata = { title: "Terms & Conditions | IFinCert" };
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-ink-900">
      <div className="mb-12 border-b border-sand-200 pb-6">
        ...
        <h1 className="font-display text-4xl font-bold text-ink-950 mb-3">Terms & Conditions</h1>
        <p className="text-ink-500 text-sm">Last updated: 2 June 2026 · Effective immediately</p>
      </div>

      <Section title="1. Acceptance of Terms">
        <p>
          By accessing or using the IFinCert platform (&ldquo;Platform&rdquo;), you agree to be bound by these
          Terms and Conditions. If you do not agree to all terms, you must not use the Platform.
          These terms constitute a legally binding agreement between you and IFinCert.
        </p>
      </Section>

      <Section title="2. Description of Service">
        <p>IFinCert provides:</p>
        ...
        <p>
          IFinCert is not a licensed financial institution, bank, or investment manager. We are a
      ...
      <Section title="4. Savings and Investment Plans">
        <p>
          The savings and investment figures on IFinCert are for tracking and goal-setting purposes only.
          IFinCert does not hold, manage, or guarantee your funds. Transfers made to FINACCESS bank
          accounts or IFinCert wallets are subject to the terms of those respective financial institutions.
        </p>
        <p>
          IFinCert makes no representation as to investment returns or savings outcomes. You bear full
      ...
      <Section title="5. Scholarship Applications">
        <p>
          ...
          reviewed on merit by the relevant scholarship committee. IFinCert reserves the right to
      ...
      <Section title="6. Candidate-Investor (C/I) Support">
        <p>
          ...
          compliant Qard Hasan or service-agreement structure. IFinCert facilitates the connection but
      ...
      <Section title="8. Intellectual Property">
        <p>
          All content on the IFinCert Platform — including text, design, graphics, and code — is the
          property of IFinCert or its licensors and is protected by applicable intellectual property
      ...
      <Section title="9. Disclaimers">
        <p>
          The Platform is provided &ldquo;as is&rdquo; and &ldquo;as available&rdquo; without warranties of any kind. IFinCert
      ...
      <Section title="10. Limitation of Liability">
        <p>
          To the maximum extent permitted by Nigerian law, IFinCert shall not be liable for any
      ...
      <Section title="13. Contact">
        <address className="not-italic text-sm space-y-1">
          <p><strong>IFinCert Legal</strong></p>
